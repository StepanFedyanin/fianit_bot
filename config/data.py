...
questions = [
        ...
        # ],
        # True),
        # Question(9, "Чем занимается Отдел финансового мониторинга? Возможно выбрать больше одного варианта ответа.", [
        #     Answer(1, "Сбор данных и согласий на обработку персональных данных", False),
        #     Answer(2, "Мониторинг законодательства РФ в области ПОД/ФТ/ФРОМУ", True),
        #     Answer(3, "Мониторинг нормативно правовых актов Банка России в области ПОД/ФТ/ФРОМУ", True),
        #     Answer(4, "Разработка технических заданий, инструкций и положений ", True),
        # ],
        # False),
